...
\caption{Latitudinal variation of ocean cell dimensions (left), and cumulative histograms of horizontal grid spacing for ocean cells (right) in the ACCESS-OM2 simulations. \FIXME{swap labels}}
...
Shortwave penetration is handled by the GFDL scheme (\mom{ocean_shortwave_gfdl_nml}), with maximum penetration of \mom{zmax_pen}=\SI{300}{m} and \citet{ManizzaLe-QuereWatsonBuitenhuis2005a} optics (\mom{optics_manizza}=true) using prescribed monthly climatological chlorophyll-a data (\mom{read chl}=true), from \param{/short/public/access-om2/input_38570c62/mom_01deg/chl.nc} at 0.1deg.
