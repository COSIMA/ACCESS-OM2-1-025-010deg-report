...
\WARNING Note that initial condition of potential temperature does not match the model prognostic conservative temperature used at $1^\circ$ and $0.25^\circ$ --- see section~\ref{S:otherparams} and \url{https://github.com/COSIMA/access-om2/issues/206}.
...
\item use \citet{LargeYeager2009a} latitude-dependent ocean albedo (\cice{cst_ocn_albedo}=false)? \url{https://github.com/COSIMA/access-om2/issues/172}. Note that this differs from MOM5's \mom{ocean_albedo_option}=3 formula.
