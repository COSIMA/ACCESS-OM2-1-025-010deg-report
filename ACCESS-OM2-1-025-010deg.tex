...
\item use new JRA55-do path \url{https://github.com/COSIMA/access-om2/issues/120} - would require membership of qv56 via \url{https://my.nci.org.au/mancini/project/} for all users.
...
\item dropped support for CORE and minimal configs (mark as deprecated) \url{https://github.com/COSIMA/access-om2/issues/183} and \url{https://arccss.slack.com/archives/C6PP0GU9Y/p1574995599016100}
...
\subsection{For all resolutions}
\begin{itemize}
\item Update NetCDF version \url{https://github.com/COSIMA/access-om2/issues/166}
\item fix up access attributes at start of sync_data.sh (access seems to get stuffed up if this times out) \url{https://climatefluidphysics.slack.com/archives/C0104HQ8K50/p1586838051081000} \TODO{see comments in .tex}
...
\item add crash resubmit stuff to standard configs \url{https://github.com/payu-org/payu/issues/241}
\item remove \mom{cdbot} from MOM namelist - it is unused, since \mom{cdbot_law_of_wall}=false (the default) % Adele email 4 April 2020
...
\item use \citet{LargeYeager2009a} latitude-dependent ocean albedo (\cice{cst_ocn_albedo}=false)? \url{https://github.com/COSIMA/access-om2/issues/172}. This would require some testing. Note that this differs from MOM5's \mom{ocean_albedo_option}=3 formula.
