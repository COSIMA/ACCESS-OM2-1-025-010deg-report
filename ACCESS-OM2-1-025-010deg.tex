...
\WARNING \TODO{CHECK: for most runs it was Levitus, not WOA13? see }\url{https://github.com/COSIMA/access-om2/issues/39}.
...
below that, with practical salinity converted to absolute salinity 
and in-situ temperature converted to potential temperature referenced to 0\,dbar
via the TEOS-10 formulas as implemented in \url{https://pypi.org/project/gsw/}.
\WARNING Note that initial conditions of potential temperature and absolute salinity do not match the model prognostic temperature and salt --- see section~\ref{S:otherparams} and \url{https://github.com/COSIMA/access-om2/issues/206}.
...
\item fix units of initial condition: \url{https://github.com/COSIMA/access-om2/issues/206}
