...
\usepackage[table,dvipsnames]{xcolor}    % loads also ÈcolortblÇ
...
plot bathymetry for the 3 resolutions -- incl difference from gebco as maps and scatter plots
...
cf. \citet{DonohueTraceyWattsChidichimoChereskin2016a}
