...
\newcommand{\BUG}[1]{\textcolor{red}{\textsf{\textbf{BUG: #1}}}}
...
\BUG{is there any way include the pdf in the git repo and also have it show an up-to-date git hash??}}}\\
...
\item note errors and problems using $\backslash$BUG\{\ldots\}
\end{itemize}
}}
