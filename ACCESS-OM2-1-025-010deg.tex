...
There are no explicit tides, but we include vertical tracer dissusivity and vertical viscosity from parameterised internal and barotropic tidal processes. 
...
\WARNING \TODO{CHECK: for most runs it was Levitus? see }\url{https://github.com/COSIMA/access-om2/issues/39}.
...
\begin {itemize}
\item update model components to support WOMBAT BGC (\url{https://github.com/mom-ocean/MOM5/pull/317} and \url{https://github.com/COSIMA/cice5/pull/47} and \url{https://github.com/COSIMA/access-om2/pull/199} and \url{https://github.com/russfiedler/MOM5/tree/wombat})
...
\item remove redundant namelist cruft --- \url{https://github.com/COSIMA/access-om2/issues/197#issuecomment-624934498}
...
\subsection{For all resolutions}
\begin{itemize}
\item explicit melt ponds in CCSM3, as in ACCESS-CM2 and \citet{RidleyBlockleyKeenRaeWestSchroeder2018a}?
...
\end{itemize}
\item Update NetCDF version to get compression with parallel I/O (PIO) \url{https://github.com/COSIMA/access-om2/issues/166}
...
\item automatically do run-summary.py?
\item Improve topography at 1 deg and 0.25 deg (\url{https://github.com/COSIMA/access-om2/issues/141} and \url{https://github.com/COSIMA/access-om2/issues/158}) - perhaps make more consistent with 0.1$^\circ$? Also make minimum depth less than $\sim$40\,m (section~\ref{S:bathymetry})?
\end{itemize}
