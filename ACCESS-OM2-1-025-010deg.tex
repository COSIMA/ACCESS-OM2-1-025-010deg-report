...
ice to ocean: stress vector, freshwater flux from rainfall and snowfall, runoff, salt flux, heat flux, shortwave flux penetrating ice, longwave flux, latent and sensible heat flux, surface pressure, ice concentration, ice meting and forming water fluxes
...
\url{http://climate-cms.unsw.wikispaces.net/JRA55-do} - data in /g/data1/rr7/JRA55
%was /g/data/ua8/JRA55-do/latest/
...
see \citet{NAS2017a}, \citet{HobbsMassomStammerjohnReidWilliamsMeier2016a}
...
\TODO{check: are there katabatic winds in JRA55? if not, does this explain our lack of coastal polynyas?}
...
Note that there are significant differences between passive microwave observational products \citep{IvanovaETAL2015a, RoachDeanRenwick2018a}.
...
Or GIOMAS from 1979-present \citep[see][]{UotilaOFarrellMarslandBi2013a}? - though this is output from a data-assimilated model at about 1 degree resolution \url{http://psc.apl.washington.edu/zhang/Global_seaice/model.html} and \url{http://psc.apl.uw.edu/data/global-sea-ice-giomas-data-sets/}
Or \citet{WorbyGeigerPagetVan-WoertAckleyDeLiberty2008a}?
Or \citet{KwokCunningham2008a}?

\citet{Hunke2010a}: parameterization of \citet{PringleEickenTrodahlBackstrom2007a} improves the otherwise slow Antarctic ice growth rate.
...
\item Improve load balance: roundrobin/sectrobin (sectrobin currently not working), experiment with block sizes and NTASK
\end{itemize}
