...
The diagnostic \param{sfc_hflux_from_runoff}  is the heat flux (relative to 0C) from liquid river runoff - see \url{https://github.com/COSIMA/access-om2/issues/139#issuecomment-639278547}.
The temperature this corresponds to is given by the diagnostic \param{temp_runoff} - see
\url{https://github.com/mom-ocean/MOM5/blob/d7ba13a/src/mom5/ocean_core/ocean_sbc.F90#L3746}.
