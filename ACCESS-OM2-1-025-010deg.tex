...
\subsection{For all resolutions}
\begin{itemize}
\item check whether normalbw is cheaper than gadi normal (would need to recompile for this)
\item stop using -lother=hyperthread and start using mpirun -mca coll_hcoll_enable 1 ? see Menadue email 3 Mar 2020 and \url{https://arccss.slack.com/archives/C9Q7Y1400/p1583209488011200}
