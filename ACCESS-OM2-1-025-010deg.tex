...
\newboolean{draft}\setboolean{draft}{false} % whether to display notes (e.g. TODO, FIXME, etc)
...
Figure~\ref{F:horizgrid} shows the grid spacing in the three models.
...
\caption{Horizontal grid spacing for the ACCESS-OM2 simulations.}
\label{F:horizgrid}
\end{figure}
