...
If you want to see the draft report as a PDF, click [here](http://cosima.org.au/wp-content/uploads/2018/08/ACCESS-OM2-1-025-010deg-7a454b4.pdf) (this might not be completely up-to-date with the sources).
...
##### Initial setup
1. Sign up [here](https://my.nci.org.au/mancini/signup/) if you don't have an NCI account. You need an NCI account in order to have access to the [VDI](http://nci.org.au/services/vdi/). You'll also need membership to the hh5 group to access the model output data - apply [here](https://my.nci.org.au/mancini/project/).
