...
**If you want to see the draft report as a PDF, click [here](http://cosima.org.au/wp-content/uploads/2020/03/ACCESS-OM2-1-025-010deg-2020-03-12-02bf205.pdf)** (this might not be completely up-to-date with the sources).
...
It provides additional technical detail beyond what is available in the model announcement paper ([Kiss et al., 2020](https://doi.org/10.5194/gmd-13-401-2020)).
